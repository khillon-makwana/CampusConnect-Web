  ...
  return (
    <div className="bg-gray-50 min-h-screen font-inter">
          ...
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:block flex-1 mx-24">
              <ul className="flex justify-center space-x-8">
                ...
                <li><Link to="/articles" className="text-primary font-medium border-b-2 border-primary pb-1 transition">ARTICLES</Link></li>
              </ul>
            </nav>
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Stay informed with insights, tips, and stories from students and professionals to enhance your academic journey.
            </p>
          </div>
          <Link to="/add-article">
        ...
        {/* Articles Listing */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6" id="articles-list">
          <UpdateArticles />
        </div>
      </main>
