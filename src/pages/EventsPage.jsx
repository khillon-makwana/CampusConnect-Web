    ...
    <div className="bg-gray-50 min-h-screen font-inter">
          ...
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:block flex-1 mx-24">
              <ul className="flex justify-center space-x-8">
                ...
                <li><a href="/events" className="text-primary font-medium border-b-2 border-primary pb-1 transition">EVENTS</a></li>
                <li><a href="/jobs" className="text-gray-600 font-medium hover:text-primary transition">JOBS</a></li>
                <li><a href="/study-groups" className="text-gray-600 font-medium hover:text-primary transition whitespace-nowrap">STUDY GROUPS</a></li>
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Stay informed about upcoming activities that match your interests, from educational seminars to hands-on learning sessions. Connect with like-minded individuals and enhance your skills through engaging experiences.
            </p>
          </div>
          <a href="/add-event">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6" >
            <UpdateEvents />{/* Cards will be injected into this container */}
        </div>
      </main>
